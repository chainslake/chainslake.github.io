...
The figure above describes the system's component architecture and data flow.
...
<p style="
    text-align: center;
"><img src="/assets/images/pages/deployment-infrastructure.png" alt="Technical components" width="550"></p>
