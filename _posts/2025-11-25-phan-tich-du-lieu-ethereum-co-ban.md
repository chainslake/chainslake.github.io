...
*Máy ảo Ethereum (EVM):* Gọi là máy ảo là bởi vì bản chất của nó là một phần mềm, tuy nhiên phần mềm này đặc biệt ở chỗ nó cho phép các chương trình chạy trên nó, tất cả các Validator sẽ cùng chạy phần mềm này, nhờ đó chúng đều có khả năng xác thực giao dịch.
